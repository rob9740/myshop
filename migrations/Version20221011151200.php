 ...
 */
final class Version20221011151200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD membre_id INT NOT NULL, ADD produit_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP membre_id, DROP produit_id');
    }
}
